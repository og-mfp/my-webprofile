...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 pt-4">
                        <img src="https://placehold.co/600x400.svg" alt="wa"
                            class="img-fluid">
                    </div>
                </div>
            </div>
        ...
        <section id="about" class="py-5">
            <div class="container">
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 align-self-center justify-content-end p-4">
                        <h2>What I do?</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Tempore quidem delectus sint deserunt possimus
                            facere ad velit ab culpa molestias!</p>
                        <ul class="nav nav-underline" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="skill-tab"
                                    type="button" role="tab"
                                    data-bs-toggle="tab"
                                    data-bs-target="#skills">Skills</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="experience-tab"
                                    type="button" role="tab"
                                    data-bs-toggle="tab"
                                    data-bs-target="#experience">Experience</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="education-tab"
                                    type="button" role="tab"
                                    data-bs-toggle="tab"
                                    data-bs-target="#education">Education</button>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content p-3" id="tabContent">
                            <div class="tab-pane fade show active" id="skills"
                                role="tabpanel">
                                <h5>Skills</h5>
                                <p>This is skill content</p>
                            </div>
                            <div class="tab-pane fade show" id="experience"
                                role="tabpanel">
                                <h5>Experience</h5>
                                <p>This is experience content</p>
                            </div>
                            <div class="tab-pane fade show" id="education"
                                role="tabpanel">
                                <h5>Education</h5>
                                <p>This is Education content</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- INTEREST SECTION -->
        <section id="interest" class="py-5 bg-dark">
            <div class="container">
                <div class="row mb-3">
                    <div class="col-md-8 offset-md-2 text-center mb-4">
                        <h2>Things I Interested</h2>
                        <p>There's a </p>
                    </div>
                    <div class="col-md-4 text-center mb-3">
                        <div class="card">
                            <div class="card-body">
                                <i class="bi bi-code-slash m-auto d-block btn btn-outline-primary pt-2 my-3"></i>
                                <h5>Lorem Ipsum</h5>
                    ...
                    <div class="col-md-4 text-center mb-3">
                        <div class="card">
                            <div class="card-body">
                                <i class="bi bi-pc-display m-auto d-block btn btn-outline-primary pt-2 my-3"></i>
                                <h5>Lorem Ipsum</h5>
                                <p>Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit.</p>
                            </div>
                    ...
                    <div class="col-md-4 text-center mb-3">
                        <div class="card">
                            <div class="card-body">
                                <i class="bi bi-airplane-fill m-auto d-block btn btn-outline-primary pt-2 my-3"></i>
                                <h5>Lorem Ipsum</h5>
                                <p>Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit.</p>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h2>Let's Connect!</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Illum blanditiis veniam quam?</p>
                    </div>
                    <div class="col-md-4 text-end align-content-center">
                        <a href="#" class="btn btn-outline-primary border-0"><i
        ...
        <!-- FOOTER -->
        <footer class="pt-4 pb-2 bg-secondary text-white text-center">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p>mfp, 2025.</p>
